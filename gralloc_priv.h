...
struct private_module_t {
    ...
    int l3da_stride;
	l3da_buffer_t* l3da_bufferTable;
	l3da_buffer_t* l3da_lastEntry;
    int pmem_master;
...
int l3da_register_buffer(gralloc_module_t const* module, buffer_handle_t handle);

int l3da_unregister_buffer(gralloc_module_t const* module, buffer_handle_t handle);
